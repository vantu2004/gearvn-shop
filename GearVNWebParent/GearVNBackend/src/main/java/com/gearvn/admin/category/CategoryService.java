...
public class CategoryService {
	...
	public List<Category> getAllCategories(String sortType) {
		return getHierarchicalCategories(sortType);
	}

	public List<Category> getHierarchicalCategories(String sortType) {
	    ...
	    // lấy danh sách rootCategories đã được sort
	    List<Category> categories = this.categoryRepository.findRootCategories(sort);
	    // duyệt lần 1
	...
	// sort subCategoríe, còn rootCategories đã được sort mặc định bên repository
